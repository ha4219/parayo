...
import io.github.ha4219.ttd.api.ApiGenerator
...
class ProductRegistrationUI(
        ...
        ui.scrollView {
            verticalLayout {
                ...
                verticalLayout{
                    ...
                    backgroundColor = 0xEEEEEE.toInt()

                    spinner{
                        this.bindStringEntries(ui.owner, viewModel.categories)
    ...
    private fun _LinearLayout.pickImageView(
        ...
        imageNum: Int
    ) = imageView(R.drawable.ic_addphoto){
